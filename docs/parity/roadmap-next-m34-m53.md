...
- `M38` `[IN-PROGRESS]`: `codec.toBase32`, `codec.fromBase32`, `codec.toBase45`, `codec.fromBase45`, `codec.toBase62`, `codec.fromBase62`, `codec.toMorseCode`, and `codec.fromMorseCode` are implemented and tested, lifting `encodings-codecs` to `32/58` tracked operations.
