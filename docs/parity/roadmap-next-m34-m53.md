...
- `M38` `[IN-PROGRESS]`: `codec.toBase32`, `codec.fromBase32`, `codec.toBase45`, `codec.fromBase45`, `codec.toBase62`, `codec.fromBase62`, `codec.toBase85`, `codec.fromBase85`, `codec.toMorseCode`, and `codec.fromMorseCode` are implemented and tested, lifting `encodings-codecs` to `34/58` tracked operations.
