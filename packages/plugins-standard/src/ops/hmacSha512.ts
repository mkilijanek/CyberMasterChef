...
export const hmacSha512: Operation = {
  id: "crypto.hmacSha512",
  name: "HMAC-SHA512",
  description: "Computes HMAC-SHA512 for input data and a provided key.",
  input: ["bytes", "string"],
  output: "string",
  args: [
    {
  ...
  run: async ({ input, args }) => {
    ...
    const signature = await signHmac(data, keyBytes, "SHA-512");
