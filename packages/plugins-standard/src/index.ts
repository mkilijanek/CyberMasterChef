...
import { adler32ChecksumAlias } from "./ops/adler32Checksum.js";
...
import { fletcher8ChecksumAlias } from "./ops/fletcher8Checksum.js";
import { fletcher16Checksum } from "./ops/fletcher16.js";
import { fletcher16ChecksumAlias } from "./ops/fletcher16Checksum.js";
import { fletcher32Checksum } from "./ops/fletcher32.js";
import { fletcher32ChecksumAlias } from "./ops/fletcher32Checksum.js";
import { fletcher64Checksum } from "./ops/fletcher64.js";
import { fletcher64ChecksumAlias } from "./ops/fletcher64Checksum.js";
...
import { generateAllHashesOp } from "./ops/generateAllHashes.js";
import { analyseHash } from "./ops/analyseHash.js";
import { hashMd5 } from "./ops/hashMd5.js";
import { md4 } from "./ops/md4.js";
import { ntHash } from "./ops/ntHash.js";
import { ripemd160 } from "./ops/ripemd160.js";
import { ripemd } from "./ops/ripemd.js";
import { sha1 } from "./ops/sha1.js";
import { sha0 } from "./ops/sha0.js";
import { sha2 } from "./ops/sha2.js";
...
import { caesarBoxCipher } from "./ops/caesarBoxCipher.js";
import { railFenceCipherEncode } from "./ops/railFenceCipherEncode.js";
import { railFenceCipherDecode } from "./ops/railFenceCipherDecode.js";
import { rc4 } from "./ops/rc4.js";
import { rc4Drop } from "./ops/rc4Drop.js";
import { bifidCipherEncode } from "./ops/bifidCipherEncode.js";
import { bifidCipherDecode } from "./ops/bifidCipherDecode.js";
import { bcrypt } from "./ops/bcrypt.js";
import { bcryptCompare } from "./ops/bcryptCompare.js";
import { bcryptParse } from "./ops/bcryptParse.js";
import { bcryptVerify } from "./ops/bcryptVerify.js";
...
import { hmac } from "./ops/hmac.js";
import { hmacSha224 } from "./ops/hmacSha224.js";
import { hmacSha256 } from "./ops/hmacSha256.js";
import { hmacSha384 } from "./ops/hmacSha384.js";
import { hmacSha512 } from "./ops/hmacSha512.js";
import { hmacMd5 } from "./ops/hmacMd5.js";
import { hmacRipemd160 } from "./ops/hmacRipemd160.js";
import { hmacWhirlpool } from "./ops/hmacWhirlpool.js";
import { extractHashes } from "./ops/extractHashes.js";
import { deriveHkdfKey } from "./ops/deriveHkdfKey.js";
import { derivePbkdf2Key } from "./ops/derivePbkdf2Key.js";
...
import { argon2 } from "./ops/argon2.js";
import { argon2Compare } from "./ops/argon2Compare.js";
...
export const standardPlugin: Plugin = {
  ...
  register(registry: OperationRegistry): void {
    ...
    registry.register(fletcher8ChecksumAlias);
    registry.register(fletcher16Checksum);
    registry.register(fletcher16ChecksumAlias);
    registry.register(fletcher32Checksum);
    registry.register(fletcher32ChecksumAlias);
    registry.register(fletcher64Checksum);
    registry.register(fletcher64ChecksumAlias);
    ...
    registry.register(bcryptCompare);
    ...
    registry.register(extractHashes);
    registry.register(deriveHkdfKey);
    registry.register(derivePbkdf2Key);
    registry.register(hkdf);
    registry.register(pbkdf2);
    registry.register(scrypt);
    registry.register(argon2d);
    registry.register(argon2);
    registry.register(argon2Compare);
